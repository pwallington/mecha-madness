 ...
 */
public class MechaMadnessView extends FrameView {

    public MechaMadnessView(SingleFrameApplication app) {
        super(app);
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = MechaMadnessApp.getApplication().getMainFrame();
            aboutBox = new MechaMadnessAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        MechaMadnessApp.getApplication().show(aboutBox);
    }
